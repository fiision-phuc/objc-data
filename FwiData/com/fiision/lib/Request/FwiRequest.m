...
- (void)setFormParams:(NSArray *)params {
    ...
    [params enumerateObjectsUsingBlock:^(FwiFormParam *param, NSUInteger idx, BOOL *stop) {
        [self _addFormParam:param];
    }];
}
...
- (void)setMultipartParams:(NSArray *)params {
    ...
    [params enumerateObjectsUsingBlock:^(FwiMultipartParam *param, NSUInteger idx, BOOL *stop) {
        [self _addMultipartParam:param];
    }];
}
